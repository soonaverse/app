...
import { LockedTokenClaimComponent } from './locked-token-claim.component';

@NgModule({
  declarations: [LockedTokenClaimComponent],
  imports: [
    CommonModule,
    NzModalModule,
    NzDrawerModule,
  ...
  exports: [LockedTokenClaimComponent],
})
export class LockedTokenClaimModule {}
